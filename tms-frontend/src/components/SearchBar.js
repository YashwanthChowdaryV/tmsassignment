...
const Navbar = () => {
  ...
  // Right menu items with hierarchical structure
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-2 sm:space-x-4">
            ...
            <div className="relative hidden md:block">
              ...
              >
                <span>Menu</span>
                <FiChevronDown className={`ml-2 transition-transform duration-200 ${isRightMenuOpen ? 'rotate-180' : ''}`} />
              </button>
                    ...
                    {rightMenuItems.map((item, index) => (
                      <div key={index} className="mb-2 last:mb-0">
                        {item.dropdown ? (
                          ...
                          <Link
                            to={item.path}
                            className="block px-3 py-2 text-sm text-gray-700 hover:bg-gray-50 hover:text-blue-600 rounded font-medium transition-colors"
                            onClick={() => {
                              setIsRightMenuOpen(false);
                              setShowSearch(false);
                            }}
